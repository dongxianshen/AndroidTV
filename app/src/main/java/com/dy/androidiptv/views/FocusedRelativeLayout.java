	...
	public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    if ((localView != null) && (this.mNodeMap.containsKey(localView)))
    {
      ...
      if (v != null)
      {
        ...
        OnFocusChangeListener localObject2 = ((View)v).getOnFocusChangeListener();
        if (localObject2 != null)
          ((OnFocusChangeListener)localObject2).onFocusChange((View)v, false);
      }
      ...
      if (localObject2 != null)
      {
        ...
        OnFocusChangeListener localOnFocusChangeListener = ((View)localObject2).getOnFocusChangeListener();
